...
<body>
    ...
    @foreach ($reportData as $employee)
        <div>
            ...
            {{-- <p>Employee Type : {{ $employee['employee_type'] }}</p> --}}

            <!-- Display Estimated Work Hours only for Regular Employees -->
            {{-- @if ($employee['employee_type'] == 'regular') --}}
                @if ($employee['estimated_records'] && $employee['total_estimated_hours'])
